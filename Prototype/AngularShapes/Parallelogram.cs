...
namespace Prototype
{
    class Parallelogram : Quadrangle, IFigure
    {
        ...
        public Parallelogram(float coordinateA1, float coordinateA2, float coordinateB1, float coordinateB2, float coordinateC1, float coordinateC2, float height)
            : base (coordinateA1, coordinateA2, coordinateB1, coordinateB2, coordinateC1, coordinateC2, coordinateD1: coordinateC1 - coordinateB1 + coordinateA1, coordinateD2: coordinateC2 - coordinateB2 + coordinateA2)
        {
